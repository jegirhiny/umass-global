...
SELECT category, COUNT(*) as app_count FROM analytics GROUP BY category HAVING app_count > 300;
...
SELECT app_name, reviews, min_installs, (min_installs * 1.0 / reviews) AS proportion FROM analytics WHERE min_installs >= 100000 ORDER BY proportion DESC LIMIT 1;