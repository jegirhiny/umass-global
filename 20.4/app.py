...
def answer():
    ...
    question_answer_pairs = zip(satisfaction_survey.questions, session.get('responses'))

    return render_template('end.html', question_answer_pairs = question_answer_pairs)
